...
public class SetAndSpawn : MiniGameBase
{
    ...
    void SpawnObject()
    {
        ...
        Instantiate(enemy, spawnPoints[index1].position, Quaternion.identity);
        Instantiate(enemy, spawnPoints[index2].position, Quaternion.identity);
